...
check action {:layer 99} AtomicNoGrayInRootScanBarrier({:linear} tid:Tid) returns (noGray: bool)
{
...
check action {:layer 99} AtomicInsertIntoSetIfWhiteInRootScanBarrier({:linear} tid:Tid, memLocal:int)
modifies Color;
{
...
check action {:layer 99,100} AtomicInsertIntoSetIfWhiteByCollector({:linear} tid:Tid, parent: int, child:int)
modifies Color;
{
    assert tid == GcTid;
...
check action {:layer 99,100} AtomicRemoveFromStack({:linear} tid:Tid) returns (isEmpty: bool, val:int)
{
    assert tid == GcTid;
...
check action {:layer 97,100} AtomicSweepNext({:linear} tid:Tid)
...
check action {:layer 97,99} AtomicCollectorRootScanBarrierEnd({:linear} tid: Tid)
modifies rootScanOn;
...
check action {:layer 96,99} AtomicInitField({:linear} tid:Tid, {:linear} mutatorTids:Set (One Piece), x: int, f: int)
modifies mem;
...
check action {:layer 96} AtomicInitializeFieldInAlloc({:linear} tid: Tid, ptr: int, fld: int)
modifies mem;
...
check action {:layer 96} AtomicReadMarkStackPtr({:linear} tid:Tid) returns (val: int)
...
check action {:layer 96} AtomicSetMarkStackPtr({:linear} tid:Tid, val: int)
modifies MarkStackPtr;
...
check action {:layer 96} AtomicReadMarkStack({:linear} tid:Tid, ptr: int) returns(val: int)
...
check action {:layer 96} AtomicWriteMarkStack({:linear} tid:Tid, ptr: int, val: int)
modifies MarkStack;
...
check action {:layer 96,99} AtomicInitCollectorPhase({:linear} tid:Tid, {:linear} mutatorTids:Set (One Piece))
modifies collectorPhase;
...
check action {:layer 96} AtomicReadCollectorPhaseLocked({:linear} tid: Tid) returns (phase:int)
...
check action {:layer 96} AtomicSetCollectorPhase({:linear} tid: Tid, phase:int)
modifies collectorPhase;
...
check action {:layer 96,99} AtomicInitMutatorPhase({:linear} tid:Tid, {:linear} mutatorTids:Set (One Piece), id: int)
modifies mutatorPhase;
...
check action {:layer 96,99} AtomicReadMutatorPhaseByMutator({:linear} tid: Tid, i: int) returns (phase:int)
...
check action {:layer 96,99} AtomicInitSweepPtr({:linear} tid:Tid, {:linear} mutatorTids:Set (One Piece))
modifies sweepPtr;
...
check action {:layer 96} AtomicReadSweepPtr({:linear} tid:Tid) returns(val:int)
...
check action {:layer 96} AtomicMutatorReadBarrierOn({:linear} tid: Tid) returns (val:bool)
...
check action {:layer 96,99} AtomicPollMutatorReadBarrierOn({:linear} tid: Tid) returns (val:bool)
{ }
...
check action {:layer 96} AtomicMutatorsInRootScanBarrierAdd({:linear} tid_left: Tid, {:linear_in} tid_right: Tid)
...
check action {:layer 96} AtomicMutatorsInRootScanBarrierRemove({:linear} tid_left: Tid) returns({:linear} tid_right: Tid)
modifies mutatorsInRootScanBarrier;
{
    var ps: Set (One Piece);
...
check action {:layer 96,99} AtomicInitRoot({:linear} tid:Tid, {:linear} mutatorTids:Set (One Piece), x: int)
modifies root;
...
check action {:layer 96,99} AtomicReadRootInRootScanBarrier({:linear} tid:Tid, x: idx) returns (val: int)
...
check action {:layer 96,99} AtomicWriteRoot({:linear} tid: Tid, i: idx, val: int)
modifies root;
...
check action {:layer 96,99} AtomicReadRoot({:linear} tid: Tid, i: idx) returns (val: int)
...
check action {:layer 96,99} AtomicInitColor({:linear} tid:Tid, {:linear} mutatorTids:Set (One Piece), x: int)
modifies Color;
...
check action {:layer 96} AtomicReadColorByCollector({:linear} tid:Tid, i: int) returns (val: int)
...
check action {:layer 96} AtomicReadColorByMutator2({:linear} tid:Tid, i: int) returns (val: int)
...
check action {:layer 96} AtomicSetColor({:linear} tid:Tid, i: int, val: int)
modifies Color;
...
check action {:layer 96} AtomicSetColorInMarkPhase({:linear} tid:Tid, i: int, val: int)
modifies Color;
{
...
check action {:layer 96,99} AtomicInitToAbs({:linear} tid:Tid, {:linear} mutatorTids:Set (One Piece))
modifies toAbs;
{
...
check action {:layer 96} AtomicLockAcquire({:linear} tid: Tid)
modifies absLock;
...
check action {:layer 96} AtomicLockRelease({:linear} tid:Tid)
modifies absLock;
